...
<div class="mltip"><span class="mlman"><?php echo ($vo['putman']); ?></span><span class="mltime"><?php echo (date('Y年m月d日',strtotime($vo['addtime']))); ?></span><span class="mlhit">浏览<font><?php echo ($vo['hit']); ?></font>次</span></div>
