...
<head>
	<title>VMUUI.COM 三点三伏系统管理中心</title>
...
<!--左侧logo开始-->
<a class="logo" href="http://<?php echo ($web); ?>" title="公司官网" target="_blank" style="margin-top:6px; margin-left:6px"><img src="/Web/System/Public/images/ManagerPage/logo.png"/></a>
