...
<head >
    <title>Present by vmuui.com 管理中心 - 修改信息</title>
...
<!--顶部导航开始-->
<div class="topnav">
<a  href="/System.php?s=/System/ManagerPage/BaseInfo.html" class="home">首页</a>><a href="/System.php?s=/System/Companyall">信息管理</a>><a href="javascript:void(0)">修改信息</a>
</div>
<!--顶部导航结束-->
<div class="cont_info">
<div class="tab_txt">
<div class="tab_tit">修改信息</div>
    ...
    <tr>
		...
		<td align="left"><input type="text" class="input1" style="width:543px" id="page_tit" name="page_tit" value="<?php echo ($info["page_tit"]); ?>"/></td>
    </tr> 
   
     <tr>
		<td align="right">页面关键字：</td>
		<td align="left"><input type="text" class="input1" style="width:543px" id="page_key" name="page_key" value="<?php echo ($info["page_key"]); ?>"/></td>
    </tr> 
   <tr>
		<td align="right">页面描述：</td>
		<td  align="left"><textarea class="input1" id="page_desc" name="page_desc"  style="width:543px; height:68px" ><?php echo ($info["page_desc"]); ?></textarea></td>
    </tr>
