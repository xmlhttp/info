...
-- ----------------------------
INSERT INTO `db_company` VALUES ('1', '1', '-20-', '分享本系统源代码', '一个简单的信息发布平台，免得在重复造轮子，直接把改系统源码分享给大家，一起学习，一起进步。', '<p><strong>一、效果</strong></p><p>效果和现在网站效果一模一样，如果要修改，可以自己修改源码。</p><p><strong>二、安装环境</strong></p><p>该系统用Thinkphp搭建，满足php+Mysql就可以了</p><p>解压后，要修改数据库连接为自己的连接，修改文件为Web/Commom/Conf/config.php<br/></p><div class=\"code\"><p>/* 数据库配置 */</p><p>&#39;DB_TYPE&#39; &nbsp; =&gt; &#39;mysqli&#39;, // 数据库类型</p><p>&#39;DB_HOST&#39; &nbsp; =&gt; &#39;127.0.0.1&#39;, // 服务器地址,修改为自己的数据库连接</p><p>&#39;DB_NAME&#39; &nbsp; =&gt; &#39;blog&#39;, // 数据库名，修改为自己的数据库名</p><p>&#39;DB_USER&#39; &nbsp; =&gt; &#39;root&#39;, // 用户名，修改为自己的数据库登录账号</p><p>&#39;DB_PWD&#39; &nbsp; &nbsp;=&gt; &#39;&#39;, &nbsp;// 密码，修改为自己的数据库登录密码</p><p>&#39;DB_PORT&#39; &nbsp; =&gt; &#39;3306&#39;, // 端口</p><p>&#39;DB_PREFIX&#39; =&gt; &#39;db_&#39;, // 数据库表前缀</p></div><p><strong>三、访问地址</strong></p><p>前台：你的地址/index.php</p><p>后台：你的地址/System.php</p><p>后台密码在数据库db_sys_admin直接改</p><p><strong>四、下载地址</strong></p><p><a href=\"https://github.com/xmlhttp/info\" target=\"_blank\" title=\"源码下载\">https://github.com/xmlhttp/info</a></p><p>这是一个非常简单的Thinkphp系统，简单到不用写目录介绍和使用方法。</p>', '37', '三点三伏', '2018-05-09 09:58:00', null, '0', '1', '0', '一个简单的信息发布平台', '一个简单的信息发布平台', '一个简单的信息发布平台');
...
-- ----------------------------
INSERT INTO `db_sys_admin` VALUES ('1', 'admin', '', '99', 'sdfsdf', '2018-05-09 11:43:24', '1', '0', '', '#', '', '', '', '0.00');
INSERT INTO `db_sys_admin` VALUES ('2', 'super admin', '', '99', 'uweb', '2018-05-09 11:43:21', '1', '0', '', '#', null, null, null, '0.00');
...
INSERT INTO `db_sys_note` VALUES ('26', 'admin', '172.16.88.66', '2018-05-09 11:34:27', 'Windows 7', 'Chrome66.0', '【企业信息】 信息ID为[1]的项修改成功', 'Company');
INSERT INTO `db_sys_note` VALUES ('27', 'admin', '172.16.88.66', '2018-05-09 11:39:08', 'Windows 7', 'Chrome66.0', '【登录】登入成功', 'sys_admin');
INSERT INTO `db_sys_note` VALUES ('28', 'admin', '172.16.88.66', '2018-05-09 11:42:29', 'Windows 7', 'Chrome66.0', '【企业信息】 信息ID为[1]的项修改成功', 'Company');
INSERT INTO `db_sys_note` VALUES ('29', 'admin', '172.16.88.66', '2018-05-09 11:42:54', 'Windows 7', 'Chrome66.0', '【企业信息】 信息ID为[1]的项修改成功', 'Company');
